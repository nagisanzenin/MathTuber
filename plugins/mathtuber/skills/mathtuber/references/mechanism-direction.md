...
Editable references live in [the public reference projects](https://github.com/nagisanzenin/MathTuber/tree/main/examples/mechanisms/references). Render evidence is added after inspection. Geometry stays exact; the warm palette and restrained outlines identify the channel without forcing one layout. Caption space remains reserved at the bottom. Sound should be tested with actual listening before claiming an artistic mix improvement.
