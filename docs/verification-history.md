...
These are past observations, not current readiness. Later milestones supersede early OAuth failures, feature plans and test counts. See [current verification](verification.md).
