...
class Film(Stage):
    def construct(self):
        ...
        self.at('Move to four');self.play(FadeOut(VGroup(prediction,total,distance_labels)),run_time=.2);self.play(q.animate.set_value(4),run_time=1.3);prediction.update(0);total.update(0);distance_labels.update(0);self.play(FadeIn(VGroup(prediction,total,distance_labels)),run_time=.3);self.at('Move to five');self.play(FadeOut(VGroup(prediction,total,distance_labels)),run_time=.2);self.play(q.animate.set_value(5),run_time=1.3);prediction.update(0);total.update(0);distance_labels.update(0);self.play(FadeIn(VGroup(prediction,total,distance_labels)),run_time=.3)
